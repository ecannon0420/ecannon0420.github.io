...
<ol>
    ...
    <li>Connecting objects to other objects via tags and components will take some getting used to</li>
    <li>Empty GameObjects are perfect for staying organized</li>
</ol>
<p>I think that by doing this tutorial, I'm starting to see how to make interactive environments that the user can explore. This will allow me to create spaces where the person viewing the story can use objects or scenes around them to further shape their experience.</p>
